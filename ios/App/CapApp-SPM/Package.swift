...
//
// NOTE (2026-07): Paths changed from Windows backslash (\\) to
// forward slash (/) for cross-platform compatibility.
// macOS / Xcode requires forward slashes for local package resolution.
//
let package = Package(
    name: "CapApp-SPM",
    platforms: [.iOS(.v15)],
