...
-- =========================================================================
-- PART 10: NOTIFICATION AND TELEMETRY TABLES
-- =========================================================================
...
-- Handle new auth.users → auto-create profile row
...
-- Auto-create daily_limits row when profile is created
...
-- Coin transaction → update wallet balance automatically
...
-- Friendship accepted → create telemetry row
...
-- Delete own account (callable by client)
...
-- =========================================================================
-- PART 12: ROW LEVEL SECURITY (RLS) — ENABLE ON ALL TABLES
-- =========================================================================
...
-- Interaction Telemetry (strictly private per friendship pair)
...
-- =========================================================================
-- PART 16: SEED DATA — GIFT CATALOG
-- =========================================================================
...
-- =========================================================================
-- PART 17: BACKFILL EXISTING USERS (safe for re-runs)
-- =========================================================================
...
-- Backfill daily_limits for any existing profiles
INSERT INTO public.daily_limits (user_id)
