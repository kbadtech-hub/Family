...
export default function ChatView({ isPremium = false }: { isPremium?: boolean }) {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full bg-white rounded-none overflow-hidden border-0 shadow-none h-full flex-1 min-h-0" style={{touchAction:'manipulation'}}>
      {/* Sidebar - Matches */}
