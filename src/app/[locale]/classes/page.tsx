    ...
    <div className="bg-[#FDFBF9] min-h-screen" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <section className="py-32 px-6 flex flex-col items-center text-center space-y-8 bg-[radial-gradient(circle_at_bottom_right,_var(--primary)_0%,_transparent_40%)] bg-opacity-5">
        ...
        <div className="flex flex-col md:flex-row gap-4 pt-6">
           <Link href="/dashboard?tab=workshops" className="btn-primary text-xl py-5 px-16 shadow-2xl shadow-primary/20 flex items-center gap-3">
      ...
      <section className="py-32 px-8 text-center bg-white">
         ...
         <Link href="/onboarding" className="inline-flex items-center gap-4 btn-primary text-2xl py-6 px-20 group shadow-2xl shadow-primary/20">
